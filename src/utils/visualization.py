...
def plotQuestion(question, ax=None):
...
def plotEmbedding(E, n=None, highlight={}, ax=None, **kwargs):
    fig, ax, area = figure(ax)
    
    if n is not None:
        params = {'s':10, 'zorder':5, 'color':"None", 'edgecolor':'black', 'lw':1, 'label':f"User {n}"}
